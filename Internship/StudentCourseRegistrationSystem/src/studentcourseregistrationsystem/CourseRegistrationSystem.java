...
public class CourseRegistrationSystem  {
    ...
    private void initialize() {
        ...
        JLabel titleLabel = new JLabel("Student Course Registration System", JLabel.CENTER);
        ...
        viewRegisteredCoursesButton.setFont(new Font("RALEWAY", Font.BOLD, 16));
        viewRegisteredCoursesButton.setBackground(new Color(0,191,255));
